...
def ionFrac(nH=1e-4, temperature=1e6, metallicity=1.0, redshift=0., indx=99999):
    plotIt = False
    ...
    os.system(f"./ionization_CIE {nH:.2e} {temperature:.2e} {metallicity:.2e} {redshift:.2f} {indx} > ./auto/auto_CIE_{indx:09}.out")     
    os.system(f"./ionization_PIE {nH:.2e} {temperature:.2e} {metallicity:.2e} {redshift:.2f} {indx} > ./auto/auto_PIE_{indx:09}.out")
